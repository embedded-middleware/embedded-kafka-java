...
public class EmbeddedKafkaProduceConsumeTest {

    private static final Logger log = LoggerFactory.getLogger(EmbeddedKafkaProduceConsumeTest.class);

    private static EmbeddedKafkaServer server;

    @BeforeAll
    public static void beforeAll() throws Exception {
        server = new EmbeddedKafkaServer();
        server.start();
